...
// Functional component for Historic genre movies
function Historic() {
  ...
  return (
    <>
      {/* Header component */}
      <Header />
      {/* Container for Historic genre movies */}
      <div className="divGenre">
        {Movies ? (
          <>
            {/* Map through movies and display only Historic genre movies */}
            {Movies.map((movies) => {
              return (
                <>
                  {movies.moviesGenre.includes(`Historic`) && (
