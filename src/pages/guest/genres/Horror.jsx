...
// Functional component for Horror genre movies
function Horror() {
  ...
  return (
    <>
      {/* Header component */}
      <Header />
      {/* Container for Horror genre movies */}
      <div className="divGenre">
        {Movies ? (
          <>
            {/* Map through movies and display only Horror genre movies */}
            {Movies.map((movies) => {
              return (
                <>
                  {movies.moviesGenre.includes(`Horror`) && (
